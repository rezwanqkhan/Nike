...
const Toast = ({ toast }) => {
  ...
  const getToastStyles = () => {
    ...
    switch (toast.type) {
      case 'success':
        typeStyles = 'text-green-800 bg-green-50 border border-green-200';
        break;
      case 'error':
        typeStyles = 'text-red-800 bg-red-50 border border-red-200';
        break;
      case 'warning':
        typeStyles = 'text-yellow-800 bg-yellow-50 border border-yellow-200';
        break;
      case 'info':
      default:
        typeStyles = 'text-blue-800 bg-blue-50 border border-blue-200';
        break;
    }
